...
public class Launcher {
    ...
    private static URI findWebResourceBase(ClassLoader classLoader)
    {
        ...
        try
        {
            ...
            try (DirectoryStream<Path> dir = Files.newDirectoryStream(pwd.resolve("web")))
            {
                for(Path path: dir)
                {
            ...
            Path srcWebapp = pwd.resolve("web/" + webResourceRef);
